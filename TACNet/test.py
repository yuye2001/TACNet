...
parser = argparse.ArgumentParser(description='PyTorch Cross-Modality Testing (TACNet)')
...
parser.add_argument('--resume-net1', default='TACNet_best.t', type=str,
...
parser.add_argument('--method', default='tacnet', type=str,
                    metavar='m', help='method type: base or tacnet')
...
parser.add_argument('--data-path', default='../../SYSU-MM01', type=str, help='path to dataset')
...
if args.method == 'base':
    net = TACNet(n_class, no_local='off', gm_pool='off', arch=args.arch)
else:
